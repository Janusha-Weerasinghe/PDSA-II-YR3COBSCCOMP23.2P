  ...
  <main>
    <div class="game-list">
      <a href="EightQueens/EightQueens.php" class="game-link">
        <div class="game-card">
          <img src="QueenIcon.png" alt="Eight Queens">
          <div class="game-info">
            <h2>Eight Queens</h2>
      ...
      <a href="TicTacToe/TicTacToe.php" class="game-link">
        <div class="game-card">
          <img src="1.jpg" alt="Tic Tac Toe">
          <div class="game-info">
            <h2>Tic Tac Toe</h2>
      ...
      <a href="ShortestPath/ShortestPath.php" class="game-link">
        <div class="game-card">
          <img src="1.jpg" alt="Shortest Path">
          <div class="game-info">
            <h2>Shortest Path</h2>
      ...
      <a href="RememberValueIndex2/RemValueIndex.php" class="game-link">
        <div class="game-card">
          <img src="1.jpg" alt="Remember Value Index">
          <div class="game-info">
      ...
      <a href="PredictValueIndex2/PredictValIndex.php" class="game-link">
        <div class="game-card">
          <img src="1.jpg" alt="Predict Value Index">
          <div class="game-info">
